...
public class PlaceController {
    ...
    @PostMapping("/add")
    public boolean addPlace(@Valid @RequestBody @NotNull(message = "{PLACE_NOT_FOUND}") PlaceDTO placeDTO) {
    ...
    @PutMapping("/edit")
    public PlaceDTO updatePlace(@Valid @RequestBody @NotNull(message = "{PLACE_NOT_FOUND}") PlaceDTO placeDTO) {
    ...
    @GetMapping("/{placeId}")
    public PlaceDTO getPlaceById(@PathVariable @Min(value = 1,message = "{ID_CONTROL}") int placeId) {
